...
export default function NotificationPanel({ onClose }: Props) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed md:absolute md:right-4 md:top-14 inset-0 md:inset-auto md:w-96 md:max-h-[70vh] bg-white md:rounded-xl md:shadow-xl z-50 flex flex-col border border-gray-200">
