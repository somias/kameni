    ...
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-4 mb-4">
      <div className="flex items-center justify-between gap-4">
        <div className="flex-1">
          <p className="font-medium text-gray-900 dark:text-gray-100 text-sm">Dodaj na početni ekran</p>
          {isIOS ? (
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
              Tapnite <span className="inline-block align-text-bottom">
              ...
              </span> Share dugme, pa <strong>"Add to Home Screen"</strong>
            </p>
          ) : (
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
              Instalirajte za brz pristup i offline podršku
            </p>
          )}
        </div>
